...
파일의 각 행에는 경험 이름 및 ID, 경험에 동적 광고가 포함되는지 여부, 크리에이티브, 번들 및 연결된 광고 태그의 수, 경험에 의사 결정 트리가 포함되는지 여부, 포함된 크리에이티브 크기, 적용 가능한 레이블, 경험에 대해 [!DNL Creative]이(가) 표시하는 썸네일 이미지, 할당된 번들의 이름 및 연결된 광고 태그의 이름 등 경험에 대한 세부 사항이 포함됩니다.
