...
1. 다음 중 하나를 수행합니다.
   ...
   * (크리에이티브가 없는 최종 노드) 노드 아래에서 **[!UICONTROL Assign Bundles]**&#x200B;을(를) 클릭합니다.

   * (기존 크리에이티브가 있는 노드) 대상 노드 아래의 크리에이티브 번들 상자 위에 커서를 놓고 **[!UICONTROL ...]** > **[!UICONTROL Edit Bundles]**&#x200B;을(를) 클릭합니다.
