...
*Adobe 광고 DSP 및 Adobe 광고 검색용*

이 광고 요구 사항 정책(&quot;정책&quot;)은 Adobe 광고를 위한 Adobe의 온디맨드 서비스(&quot;서비스&quot;)를 통해 배포되는 광고에 대한 요구 사항을 설명합니다. 이 정책은 온디맨드 서비스를 사용하는 Adobe과 고객(&quot;귀하&quot;) 간의 계약에 참조로서 통합됩니다. 본 정책에 사용되지만 본 계약에서 정의되지 않은 자본화된 용어는 해당 계약에 명시된 의미를 갖습니다.
...
온디맨드 서비스를 통해 귀하가 전송, 저장, 표시, 배포 또는 기타 방법으로 사용할 수 있는 모든 광고는 수시로 Adobe에 의해 수정될 수 있는 Adobe 광고 사양에 포함된 광고 사양과 일치해야 합니다.
