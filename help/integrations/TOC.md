...
+ [!DNL Analytics for Advertising] {#analytics}
   ...
   + 구현 계획 {#planning}
      + [&#x200B; [!DNL Analytics for Advertising]을(를) 구현하기 위한 필수 구성 요소 및 주요 정보](/help/integrations/analytics/prerequisites.md)
...
+ Adobe Audience Manager과 통합 {#audience-manager}
   ...
   + Adobe Audience Manager과 DSP 미디어 데이터 통합 {#media-data-ingestion}
      ...
      + [DSP 캠페인에서 노출 횟수 및 클릭 데이터 수집](/help/integrations/audience-manager/media-data-integration/collect.md)
...
+ Adobe Target과 통합 {#target}
   + [DSP 광고를 위한 Adobe Target에서 A/B 테스트 구성](/help/integrations/target/ab-tests-dsp.md)
