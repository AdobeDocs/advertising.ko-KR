...
* (광고주: [!DNL Analytics]) 광고주는 [ [!DNL Analytics]  버전 1.6.4 이상을 사용하여 `appMeasurement.js`구현](https://experienceleague.adobe.com/en/docs/analytics/implementation/js/overview)해야 합니다.
