...
* 조직은 Experience Cloud 서비스에 대해 [활성화됨](https://experienceleague.adobe.com/ko/docs/core-services/interface/services/overview)이어야 하며 [!DNL Organization ID] Experience Cloud(이전 이름: [!DNL IMS org ID])이 있어야 합니다.
