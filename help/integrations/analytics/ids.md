...
* 뷰스루 항목은 사용자가 광고를 보고 사이트를 방문하지만 클릭하지 않을 때 캡처됩니다. [!DNL Analytics] 다음 두 가지 조건이 충족되는 경우 뷰스루를 기록합니다.
   * 방문자에게 클릭스루가 없습니다. [!DNL DSP] 또는 [!DNL Search] 다음 기간 동안 광고 [전환 확인 기간 클릭](#lookback-a4adc).
...
### 에 대한 AMO ID 포맷 [!DNL Search]

에 대한 AMO ID [!DNL Search] 각 검색 엔진에 대해 고유한 형식을 따르십시오. 모든 검색 엔진의 형식은 다음으로 시작됩니다.
