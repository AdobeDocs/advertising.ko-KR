...
[!DNL Analytics] analytics 히트 내에서 Adobe 광고 ID(AMO ID)를 설정하여 광고주의 eVar 지속성 설정에 따라 클릭스루와 뷰스루 모두에 적용됩니다. 지속성 설정은 Adobe 광고 백 엔드에서 구성되며 Adobe 계정 팀이 변경할 수 있습니다.
...
각 채널에서 지원되는 최신 광고 환경에 대해서는 Adobe 계정 팀에 문의하십시오.
