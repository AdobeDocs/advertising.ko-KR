...
[!DNL Analytics for Advertising] 통합 트랙이 있는 광고주는 Adobe Advertising 및 Adobe Analytics을 통해 유료 광고를 합니다. 여러 시스템을 통해 미디어, 캠페인 및 채널을 추적할 때 다른 시스템의 동일한 데이터 세트가 완전히 일치하는 경우는 거의 없습니다. 이 문서에서는 Adobe Advertising을 통해 거래되는 미디어에 대한 데이터를 [!DNL Analytics] 내에서 미디어가 추적되는 다른 시스템의 데이터와 비교하는 방법에 대해 설명합니다.
