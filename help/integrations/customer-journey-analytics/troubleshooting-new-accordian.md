...
데이터 스트림의 에지 구성에서 자사 도메인을 구성하여 자사 CNAME 데이터 수집으로 마이그레이션합니다.
...
| [!UICONTROL Adobe Experience Platform WebSDK] | 실행된 각 이벤트, 전체 XDM 페이로드 및 Edge 응답을 표시합니다. |
...
* [!DNL Adobe Experience Platform] 디버거에서 이벤트가 가장자리에 도달하고 있는지 확인합니다.
