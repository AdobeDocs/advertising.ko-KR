...
+ 캠페인 관리 {#campaign-management}
   ...
   + 광고 {#ads}
      ...
      + [여러 서드파티 광고 만들기](/help/dsp/campaign-management/ads/ad-create-multiple.md)
...
+ 대상자 {#audiences}
   ...
   + 세그먼트 {#segments}
      ...
      + [!UICONTROL CCPA Opt-out-of-Sale]개 세그먼트 {#ccpa-opt-out-of-sale-segments}
         ...
         + [[!UICONTROL Consumer Opt-Out-of-Sale] 보고서 검색](/help/dsp/audiences/ccpa-opt-out-segment-report-retrieve.md)
   ...
   + 소스 {#sources}
      ...
      + 고객 데이터 플랫폼별 워크플로우 {#sources-workflows}
...
+ 인벤토리 {#inventory}
   ...
   + [!DNL On Demand] 인벤토리 {#on-demand}
      + [약 [!DNL On Demand] 프리미엄 인벤토리](/help/dsp/inventory/on-demand-inventory-about.md)
...
+ 사용자 정의 보고서 {#custom-reports}
   ...
   + [사용자 정의 보고서 만들기](/help/dsp/reports/report-create.md)
   + [사용자 정의 보고서 복제](/help/dsp/reports/report-copy.md)
   + [사용자 정의 보고서 편집](/help/dsp/reports/report-edit.md)
...
+ 플래너 {#planner}
   ...
   + [연결된 TV Reach 플랜 만들기](/help/dsp/planner/planner-create.md)
