...
하나 이상의 패키지에 대한 설정을 검토를 위해 XLSX([!DNL Microsoft Excel] 스프레드시트) 형식으로 다운로드할 수 있습니다. *일괄 시트* 파일에는 비행 정보가 포함된 별도의 탭이 포함되어 있습니다.

여러 설정을 한 번에 업데이트하려면 다음 중 하나를 수행할 수 있습니다.

* 필드 선택을 변경하고, 파일을 저장하고, 편집된 일괄 시트 파일을 다시 DSP에 업로드합니다.

* 캠페인에서 추가 패키지, 배치 또는 광고를 변경하려면 캠페인에 대한 일괄 시트를 다운로드하십시오. 업데이트된 설정을 입력하거나 파일에 붙여넣은 다음 파일을 업로드하여 변경합니다. 지침은 &quot;[일괄 시트를 사용하여 캠페인 구성 요소 설정 검토 및 편집](/help/dsp/campaign-management/campaign-components-review-edit.md)&quot;을 참조하십시오.
...
## 캠페인의 모든 패키지에 대한 다운로드 설정

캠페인의 모든 패키지에 대한 설정을 다운로드할 때 일괄 시트에는 패키지 설정 및 비행 정보에 대한 별도의 탭이 포함됩니다. 패키지와 연결된 배치 및 광고에 대한 설정을 선택적으로 포함할 수 있습니다. 배치 및 광고 설정에 대한 추가 탭이 포함됩니다.
...
1. 파일을 다운로드하려면 다음 중 하나를 수행합니다.
   ...
   * 상단 메뉴 모음 오른쪽에서 ![작업](/help/dsp/assets/downloads.png)을 클릭합니다. 작업 옆에 있는 **[!UICONTROL Download]**&#x200B;을(를) 클릭합니다.
     ...
     설정을 편집하려면 파일을 직접 편집한 다음 변경 사항을 업로드하십시오. 편집 가능한 모든 열이 파란색으로 강조 표시됩니다.
...
1. 일괄 시트를 다운로드하려면 다음 중 하나를 수행하십시오.
   ...
   * 상단 메뉴 모음 오른쪽에서 ![작업](/help/dsp/assets/downloads.png)을 클릭합니다. 작업 옆에 있는 **[!UICONTROL Download]**&#x200B;을(를) 클릭합니다.
     ...
     파일은 브라우저의 다운로드 폴더에 저장됩니다. 포함된 열의 목록은 &quot;[다운로드한/업로드한 일괄 시트의 배치 열](#qa-sheet-columns)&quot;을 참조하십시오.
...
1. 다음 중 하나를 수행합니다.
   ...
   * 하위 메뉴에서 **[!UICONTROL Packages]**&#x200B;을(를) 클릭하고 패키지의 확인란을 선택합니다. 일괄 작업 도구 모음에서 **[!UICONTROL ...]** > **[!UICONTROL Upload Bulksheet]**&#x200B;을(를) 클릭합니다.
