...
| [!UICONTROL Goals & Budget] | [!UICONTROL Package Goal Type] | (사용자 지정 최적화 목표가 있는 패키지만 해당) 패키지의 목적으로, 패키지를 최적화하는 방법을 결정하는 데 도움이 됩니다. *[!UICONTROL Prospecting]*, *[!UICONTROL Retargeting]* 또는 *[!UICONTROL Other]* . | — |
...
| [!UICONTROL Flight details] | [!UICONTROL Flight Start Date] | 비행의 첫 번째 날짜. | — |
| [!UICONTROL Flight details] | [!UICONTROL Flight End Date] | 최종 비행 날짜. | — |
| [!UICONTROL Flight details] | [!UICONTROL Flight Budget] | 타겟이 비행에 대한 지출 목표입니다. | — |
| [!UICONTROL Flight details] | [!UICONTROL Rollover] | (&quot;[!UICONTROL Automatically rollover remaining flight budget to next flight]&quot; 옵션이 활성화되지 않은 기존 패키지) 다음 항공편에 추가할 지출되지 않을 수 있는 예산 금액입니다. | — |
