...
게시자와 직접 관계를 맺고 있는 경우 Advertising DSP 배치에서 협상된 인벤토리 및 가격 책정 기능을 제공하는 자체 비공개 거래를 사용하여 미디어 구매 프로세스 및 워크플로를 간소화할 수 있습니다. DSP은 계정을 설정할 때 모든 게시자와 통합됩니다. 나중에 추가 게시자에 액세스하려면 Adobe 계정 팀에 문의하여 액세스 권한을 설정하십시오.
...
필터를 적용하고, 표시되는 열을 사용자 지정하고, 선택적으로 사용자 지정 보기를 저장하고, 열을 정렬하고, 데이터를 차트로 확인하여 표시되는 거래 데이터를 사용자 지정할 수 있습니다.

## [!UICONTROL Deal Lists] 보기
