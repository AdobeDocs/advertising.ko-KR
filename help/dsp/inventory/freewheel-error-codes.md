...
| [!DNL Invalid external_deal_id:] \&lt;deal_id\> | 제출된 거래 ID가 존재하지 않거나 Adobe 측에서는 활성화되지 않습니다. | 거래가 활성 상태인지 확인한 다음 광고를 다시 제출합니다. |
| [!DNL \[public_id=]\&lt;deal\>]이(가) 없습니다. | 제출된 거래 ID가 [!DNL FreeWheel] 끝에 없습니다. | 거래 ID를 확인하려면 [!DNL FreeWheel] 담당자에게 문의하세요. |
| [!DNL Ad with identifier] \&lt;*광고 이름*\> [!DNL was not found.] | 제출된 광고 키가 Adobe에 존재하지 않거나 활성화되어 있지 않습니다. | 올바른 광고 키를 찾은 다음 광고를 다시 제출합니다. |
...
| DATA_DEAL_GET_FAILURE | 422 | 거래를 찾을 수 없거나 구성에 문제가 있습니다. 자세한 내용은 오류 메시지를 확인하십시오. |
...
| DATA_DSP_GET_FAILURE | 422 | DSP이 시스템 내에 존재하지 않습니다. |
| DATA_CREATIVE_UNLINK_FAILURE | 422 | 광고 단위에서 크리에이티브의 연결이 해제되지 않았습니다. |
| DATA_CREATIVE_DELETE_FAILURE | 422 | 크리에이티브가 삭제되지 않았습니다. |
