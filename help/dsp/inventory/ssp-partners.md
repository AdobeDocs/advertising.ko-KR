...
>[!TIP]
>
>다음 테이블은 넓습니다. 필요한 경우 표 하단에 있는 스크롤 막대를 사용하여 전체 내용을 봅니다. 왼쪽 창 위쪽에 있는 ![왼쪽 창 숨기기](/help/dsp/assets/hide-left-pane.png "왼쪽 창 숨기기") 또는 오른쪽 창 위쪽에 있는 ![오른쪽 창 숨기기](/help/dsp/assets/hide-right-pane.png "오른쪽 창 숨기기")을 클릭하여 목차 또는 오른쪽 창을 일시적으로 숨길 수도 있습니다.
...
| [!DNL AppNexus] | [!DNL Xandr] | 비디오 시트 ID: 9094<br>디스플레이 시트 ID: 3939 | 아니요 | 글로벌 | 미국 달러 | x | x | x | x | x |  |  |
...
| [!DNL Google Authorized Buyers](이전 [!DNL Google AdX]) | [!DNL Google] | Adobe NA - 44912714<br>Adobe APAC 및 EU - 89185975 | 예 | 글로벌 | USD, BRL | x | x | x | x | x |  | x |
...
| [!DNL Teads] |  | [!DNL TubeMogul] 또는 Adobe Advertising | 아니요 | 아웃스트림 비디오 = 글로벌<br>디스플레이 = NA + EMEA | 미국 달러 | x | x |  | x | x |  |  |
