...
[!UICONTROL Simple Ad Serving]을(를) 사용하면 각 광고는 게시자가 직접 제공하며(사이트 서비스), DSP에서는 게시자에게 전송할 이벤트 추적 픽셀을 제공합니다. 게시자는 DSP 광고의 픽셀 및 트래픽을 구현해야 합니다. 이벤트 픽셀은 인벤토리 유형에 따라 노출, 클릭스루 및 비디오 재생 이벤트를 측정합니다.
