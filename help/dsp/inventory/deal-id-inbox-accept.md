...
>[!NOTE]
>
>[!DNL FreeWheel]에서 게시자와 프로그래밍 방식으로 보장되는 거래를 설정하려면 추가 권한과 단계가 필요합니다. 자세한 내용은 &quot;[FreeWheel의 프로그램 보증 거래 설정 개요](freewheel-overview.md)&quot;를 참조하십시오.
...
>[!MORELIKETHIS]
>
>* [[!UICONTROL Deal ID Inbox]](deal-id-inbox-about.md) 정보
