---
title: 연결된 TV 도달 계획에 대한 예측 내보내기
...
# 연결된 TV 도달 계획에 대한 예측 내보내기

[!UICONTROL Budget vs Reach] 및 [!DNL Microsoft Excel] 열이 있는 [!UICONTROL Budget] 스프레드시트**로 [!UICONTROL Reach] 예측을 내보낼 수 있습니다.
