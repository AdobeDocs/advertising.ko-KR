...
또한 전체 목표를 이끄는 성공 이벤트를 결정하고 그에 따라 사용자 지정 목표를 만들어야 합니다. 각 패키지에 대해 [!DNL Adobe AI]을(를) 사용하여 보고 및 알고리즘 최적화를 위한 전체 최적화 목표와 함께 사용할 사용자 지정 목표를 지정합니다. 사용자 지정 목표에 대한 자세한 내용은 &quot;[사용자 지정 목표 관리](/help/dsp/admin/custom-objectives-manage.md)&quot; 및 &quot;[사용자 지정 목표에 대한 모범 사례](custom-goal.md)&quot;를 참조하십시오.
