...
# Advertising DSP에서 캠페인을 최적화하는 방법
...
KPI를 달성하는 데 도움이 될 수 있는 최적화 목표를 결정하려면 [최적화 목표와 이를 사용하는 방법](optimization-goals.md)을 참조하십시오.
...
### 비용 효율성과 성능 간의 균형을 최우선으로 고려하는 패키지
...
KPI를 달성하는 데 도움이 될 수 있는 사전 입찰 필터를 결정하려면 [배치 수준 사전 입찰 필터 및 사용 방법](optimization-pre-bid-filters.md)을 참조하세요.
