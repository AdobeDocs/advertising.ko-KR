...
DSP은 [!DNL DoubleVerify]과(와) 파트너 관계를 맺고 [!DNL Authentic Brand Suitability] 타깃팅 솔루션을 제공합니다. 이를 통해 일관성을 위해 모든 구매 플랫폼에서 타깃팅할 중앙 집중식 브랜드 적합성 요구 사항 집합을 만들 수 있습니다.

필요한 타깃팅으로 [!DNL DoubleVerify] 세그먼트를 빌드했으면 DSP 내에서 이를 사용하여 웹 환경 전반에 걸쳐 사전 입찰을 통해 입찰 후 블록 규칙을 복제할 수 있습니다.

각 광고주에 대해 [!DNL DoubleVerify] 세그먼트 ID를 지정한 다음 선택적으로 [각 배치에 대해 [!UICONTROL Authentic Brand Suitability]을(를) 활성화 또는 비활성화](/help/dsp/campaign-management/placements/placement-settings.md)할 수 있습니다. DSP은 세그먼트 ID에 대한 사용을 위해 계정에 청구합니다.
