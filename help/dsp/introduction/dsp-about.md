...
* [**최적화**](features/optimization.md): [!DNL Campaign Home]은(는) 이전 어느 때보다 빠르게 캠페인을 관리하고 최적화할 수 있는 고급 도구, 정렬 및 통찰력을 제공합니다. 또한 예측 및 지출 권장 사항은 현재 성과가 가장 좋은 것이 아니라, 성과가 좋을 것으로 예상되는 전략을 예측하므로 데이터를 통해 최적화할 수 있습니다.
