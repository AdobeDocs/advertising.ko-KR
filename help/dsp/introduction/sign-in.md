...
Adobe Advertising DSP이 로그인 인증을 위해 Adobe Identity Management 서비스(IMS)로 전환하고 있습니다. IMS는 Real-Time Customer Data Platform, Customer Journey Analytics, [!DNL Adobe] 및 [!DNL Target]을(를) 포함하여 IMS를 지원하는 모든 [!DNL Analytics] 제품에 Federated ID를 사용하여 SSO(Single Sign-On) 액세스를 제공합니다. 변경 사항:
