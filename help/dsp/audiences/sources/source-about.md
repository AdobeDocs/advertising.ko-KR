...
DSP은 Adobe Experience Platform의 일부인 *the*[에 대한 통합  [!DNL Adobe Real-Time CDP]대상](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/overview.html)입니다.
