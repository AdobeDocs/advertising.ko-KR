...
1. 대상자 행 위에 커서를 놓고 **[!UICONTROL Duplicate]**&#x200B;을(를) 클릭합니다.

1. (선택 사항) 기본 대상 이름을 다른 고유한 이름으로 변경합니다.

   기본적으로 새 대상은 &quot;[대상] 복사본&quot;이라고 합니다.

1. **[!UICONTROL Duplicate]**&#x200B;을(를) 클릭합니다.

1. (선택 사항) [새 대상을 세분화](reusable-audience-edit.md)합니다.
