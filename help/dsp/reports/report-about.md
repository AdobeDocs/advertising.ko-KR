...
* 사전 구성된 보고서 템플릿
   ...
   * **[!UICONTROL All-in Cost]**: (Advertising Creative 및 Advertising DSP을 모두 사용하는 광고주만 해당) 이 보고서를 사용하여 Advertising DSP 지출이 Adobe Creative의 광고 제공으로 인한 것인지 확인하십시오. 캠페인, 패키지, 배치 및 광고 수준에서 크리에이티브, 속성, 타겟 및 기타 데이터를 볼 수 있습니다.
