...
|   | 공유 | (사용자 정의 보기 전용, 선택 사항) 광고주의 데이터를 볼 수 있는 다른 모든 사용자가 보기를 사용할 수 있습니다. 다른 사용자는 보기를 편집하거나 삭제할 수 없지만 설정에서 새 보기를 만들 수 있습니다. 보기 목록에서 다른 사용자가 공유하고 있는 각 보기는 이탤릭체로 표시됩니다(예: &quot;_가장 성과가 좋은 캠페인_&quot;). |
