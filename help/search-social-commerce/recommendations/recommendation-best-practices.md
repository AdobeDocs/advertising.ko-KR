...
|--- |--- |--- |--- |
| [!UICONTROL Ads] 및 확장(이제 [!DNL Google Ads]에서 &quot;광고 및 자산&quot;이라고 함) | 광고 및 에셋 추가/편집용 Recommendations | 자동으로 적용할 수 있지만 광고주는 권장 사항을 수동으로 검토해야 합니다. | 반응형 검색 광고가 광고주 요구 사항에 부합하는지 확인하려면 권장 사항을 검토해야 합니다. |
