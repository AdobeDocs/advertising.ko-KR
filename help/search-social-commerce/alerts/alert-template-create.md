...
1. [!UICONTROL Create \[Entity\] Alert] 창에서 [, ](alert-template-settings.md) 및 **[!UICONTROL Date Range]** 탭에서 **[!UICONTROL Filters]**&#x200B;경고 설정&#x200B;**[!UICONTROL Scheduling and Delivery]**&#x200B;을(를) 지정합니다.
...
1. [!UICONTROL Create \[Entity type\] Alert] 창에서 [, ](alert-template-settings.md) 및 **[!UICONTROL Date Range]** 탭에서 **[!UICONTROL Filters]**&#x200B;경고 설정&#x200B;**[!UICONTROL Scheduling and Delivery]**&#x200B;을(를) 지정합니다.
