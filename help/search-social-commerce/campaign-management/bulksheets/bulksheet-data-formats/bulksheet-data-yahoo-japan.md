...
| [!UICONTROL Location] | 해당 사항 없음 | 해당 사항 없음 | 해당 사항 없음 | 해당 사항 없음 | 선택 사항 | 캠페인을 위한 광고를 배치할 지리적 위치입니다. 도시의 경우 &quot;&lt;<i>City</i>>, &lt;</i>Prefecture</i>>&quot; 형식(예: 도쿄 아다치)을 사용하십시오. 위치를 제외하려면 위치 앞에 빼기 기호(`-`)를 붙입니다. 캠페인에 대한 특정 값을 입력하지 않으면 모든 위치가 타깃팅됩니다. |
