...
| [!UICONTROL Location Status] | 해당 사항 없음 | 해당 사항 없음 | 해당 사항 없음 | 해당 사항 없음 | 선택 사항입니다 | 위치 대상의 상태: *[!UICONTROL Active]* 또는 *[!UICONTROL Deleted]* (기존 위치만 해당) 새 위치의 기본값은 입니다. [!UICONTROL Active]. 활성 위치를 삭제하려면 값을 입력합니다 `Deleted`. |
