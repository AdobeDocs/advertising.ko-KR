...
| [!UICONTROL Call To Action] | 광고에 포함할 클릭 유도 문안. 가능한 값의 목록은 [API 참조를 참조하십시오](https://learn.microsoft.com/en-us/advertising/campaign-management-service/calltoaction). 하지만 작업에 대한 여러 단어 호출을 일괄 시트에 여러 단어(예: &quot;BetNow&quot; 대신 &quot;Bet Now&quot;)로 입력하십시오. |
| [!UICONTROL Call To Action Language] | 콜 투 액션 옵션에 대한 언어입니다. 가능한 언어 목록은 [API 참조를 참조하십시오](https://learn.microsoft.com/en-us/advertising/campaign-management-service/languagename). |
