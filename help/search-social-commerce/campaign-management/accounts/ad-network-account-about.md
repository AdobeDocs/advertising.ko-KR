...
*[!DNL Google Ads], [!DNL LY Ads]&#x200B;(이전 [!DNL Yahoo! Japan Ads]), [!DNL Microsoft Advertising]&#x200B;(이전 [!DNL Bing Ads]), [!DNL Yahoo DSP]&#x200B;(이전 [!DNL Yahoo! Display Network]), [!DNL Yandex] 및 기존 [!DNL Baidu] 계정*

Search, Social 및 Commerce은 지원되는 광고 네트워크 계정과 동기화(*동기화*)하므로 광고의 성능을 추적, 보고 및 시각화할 수 있습니다. [!DNL Yahoo DSP]을(를) 제외한 모든 광고 네트워크의 경우 선택적으로 검색, 소셜 및 Commerce에서 계정에 대한 캠페인을 관리할 수 있습니다. [!DNL Yahoo DSP], 캠페인은 읽기 전용입니다. 모든 광고 네트워크에 대해 포트폴리오에 캠페인을 추가하여 관리 계정의 캠페인에 대한 입찰, 캠페인 예산 및 캠페인 입찰 전략 타겟을 최적화하는 최적화 기능을 허용할 수 있습니다.
