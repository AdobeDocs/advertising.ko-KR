...
1. 다음을 지정합니다. [계정 설정](#account-settings):
   ...
   1. 다음에서 **[!UICONTROL Account Details]** 섹션에서 계정 세부 정보를 입력합니다.
      ...
      로그인 인증 유형 을 사용하는 광고 네트워크의 경우 &quot;[!UICONTROL oAuth],&quot; 검색, 소셜 및 상거래를 통해 [OAuth 인증 프로토콜](https://oauth.net/2/):
...
검색, Social 및 Commerce가 [OAuth 인증 프로토콜](https://oauth.net/2/) 계정 자격 증명이 변경되거나 검색, 소셜 및 상거래의 새로운 기능을 지원하기 위해 추가 액세스가 필요한 경우 계정에 대한 새 액세스 토큰을 받아야 합니다.
