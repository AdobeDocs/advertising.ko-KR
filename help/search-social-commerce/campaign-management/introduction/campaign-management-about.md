...
Adobe Advertising 전환 추적 서비스를 사용하는 경우 랜딩 페이지 접미사에 검색, 소셜 및 Commerce 클릭 추적 코드, 추적 템플릿 및 광고, 키워드, 배치, 사이트링크 및 제품 목록에 대한 최종/대상 URL을 포함해야 합니다. 캠페인 설정에 &quot;[&quot; 및 &quot;](/help/search-social-commerce/introduction/supported-inventory.md)&quot;이(가) 포함된 [!UICONTROL EF Redirect]지원되는 광고 네트워크 및 캠페인 유형[!UICONTROL Auto Upload]의 경우 레코드를 저장할 때 검색, 소셜 및 Commerce에서 자동으로 리디렉션 및 추적 코드를 추가하므로 수동으로 추가할 필요가 없습니다. 그렇지 않으면 코드를 추적 템플릿 또는 최종 URL에 수동으로 추가해야 합니다.
...
사용 가능한 포트폴리오 옵션 및 포트폴리오 설정 방법에 대한 자세한 내용은 Search, Social 및 Commerce 내에서 사용할 수 있는 &quot;포트폴리오&quot;에 대한 최적화 안내서 장을 참조하십시오.<!-- verify convention for referencing Optimization Guide here -->
...
* **[!UICONTROL Advanced (ACM)]** — [!DNL Advanced]&#x200B;([!DNL AMC], 고급 캠페인 관리의 경우) 보기에서, 사용자가 만든 광고 네트워크별 광고 템플릿과 FTP 위치에 업로드한 [&#x200B; 계정 또는 인벤토리 데이터 파일의 내용에 따라 인벤토리의 각 항목에 타깃팅된 &#x200B;](/help/search-social-commerce/campaign-management/inventory-feeds/inventory-feeds-about.md)동적 광고 및 키워드[!DNL Google Merchant Center]를 만드는 자동화된 프로세스를 설정할 수 있습니다. 하위 보기는 광고주에 대한 각 피드 템플릿에 대한 세부 정보를 보여주며, 피드 템플릿을 통해 전파되었지만 광고 네트워크에 게시되지 않은 피드에 포함된 각 캠페인, 광고 그룹, 키워드 및 광고를 보여줍니다.

* **[!UICONTROL Bulksheets]** — [!UICONTROL Bulksheets] 보기를 사용하여 [지원되는 광고 네트워크](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-about.md)에서 계정에 대해 원하는 만큼의 데이터를 포함하는 [일괄 시트 파일](/help/search-social-commerce/introduction/supported-inventory.md)을 만든 다음 광고 네트워크에 게시합니다.
