...
description: 의 유형에 대해 알아보기 [!DNL Microsoft® Advertising]- 추적된 전환 데이터를 검색, 소셜 및 상거래에서 사용할 수 있습니다.
...
Search, Social 및 Commerce는 사용자가 추적한 모든 전환을 자동으로 동기화합니다. [[!DNL Microsoft® Advertising] 범용 이벤트 추적(UET) 태그](https://about.ads.microsoft.com/solutions/tools/universal-event-tracking) (뷰스루 변환 포함), 보고 및 최적화를 위한 웹 사이트 전환용.
