...
[동기화된 검색 엔진 계정 [!DNL Google Ads]  내에서 디스플레이 네트워크를 타깃팅하는 ](/help/search-social-commerce/introduction/supported-inventory.md)지원됨[캠페인 유형](/help/search-social-commerce/campaign-management/accounts/ad-network-account-about.md)의 모든 광고 그룹에 대한 배치를 만들 수 있습니다.
