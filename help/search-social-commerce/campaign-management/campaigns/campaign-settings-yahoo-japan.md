...
description: ' [!DNL Yahoo! Japan Ads] 캠페인에 대한 설정을 참조합니다.'
...
**[!UICONTROL Campaign Type]:**(캠페인 생성 중에만 사용 가능) 광고를 배치할 위치: 검색 네트워크에 텍스트 광고를 표시하는 유일한 옵션은 *[!UICONTROL Search Network Only]*&#x200B;입니다.
