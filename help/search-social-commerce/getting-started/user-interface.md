...
* **[!UICONTROL Manage]** 하위 메뉴:
   ...
   * **[!UICONTROL Portfolio Groups]:** 새 UI 사이트를 종료하고 기존 [!UICONTROL Search, Social, & Commerce] > [!UICONTROL Optimization] > [!UICONTROL Portfolios] 보기 > [!UICONTROL Portfolio Groups] 탭을 엽니다.
...
데이터를 볼 수 있는 공간이 더 필요하면 기본 메뉴를 축소합니다.

* 왼쪽의 기본 메뉴 위에서 ![축소/확장](/help/search-social-commerce/assets/collapse-expand.png "축소/확장")을 클릭합니다.

### 메인 메뉴 옵션 검색

기본 메뉴 위의 검색 필드를 사용하여 &quot;포트폴리오&quot; 또는 &quot;보고서&quot;와 같은 특정 메뉴 옵션을 찾습니다.
