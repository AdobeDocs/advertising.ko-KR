...
* [Adobe Experience Platform의 태그](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/overview.html) — Adobe Experience Platform용 [Adobe Advertising Cloud 확장](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/advertising/adobe-advertising-cloud)을 사용하여 광고 랜딩 페이지에 대해 [Adobe Advertising 전환 추적 태그 만들기](/help/search-social-commerce/tools/conversion-tag-generate.md)와 타사 추적 태그를 만들 수 있습니다. 조직에 Experience Platform 계정이 없는 경우에도 Adobe CX 엔터프라이즈 고객이 무료로 사용할 수 있는 [Adobe Experience Platform 데이터 수집용 사용자 인터페이스](https://experience.adobe.com/#/data-collection/)에서 직접 확장을 설치할 수 있습니다.
