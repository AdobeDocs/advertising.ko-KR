...
* `<advertiser_ID>`은(는) Adobe Advertising 내의 광고주에게 할당된 고유한 사용자 ID에 대한 변수입니다.
...
* `<ad network ID>`은(는) 지정한 광고 네트워크에 대한 숫자 ID의 변수입니다(예: *의* 3[!DNL Google Ads], *의* 10[!DNL Microsoft Advertising], *의* 45[!DNL Meta], *의* 86[!DNL Yahoo! Display Network], *의* 87[!DNL Naver], *의* 87[!DNL Baidu], *의* 90[!DNL Yandex], *의* 94[!DNL Yahoo! Japan Ads], *의* 105[!DNL Yahoo Native])(더 이상 사용되지 않음) 또는 *용* 106[!DNL Pinterest]&#x200B;(더 이상 사용되지 않음).
...
>* [에 대한  [!DNL Google Ads]](formats-click-tracking-google.md)클릭 추적 형식
>* [에 대한  [!DNL Microsoft Advertising]](formats-click-tracking-microsoft.md)클릭 추적 형식
