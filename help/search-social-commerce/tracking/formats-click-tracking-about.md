...
* `<ad network ID>`은(는) 지정한 광고 네트워크의 숫자 ID에 대한 변수입니다(예: [!DNL Google Ads]의 *3*, [!DNL Microsoft Advertising]의 *10*, [!DNL Meta]의 *45*, [!DNL Yahoo! Display Network]의 *86*, [!DNL Naver]의 *87*, [!DNL Baidu]의 *87*, [!DNL Yandex]의 *90*, [!DNL LY Ads]의 *94*(이전의 [!DNL Yahoo! Japan Ads]), [!DNL Yahoo Native]의 *105*)(더 이상 사용되지 않음) 또는 [!DNL Pinterest]용 *106*(더 이상 사용되지 않음).
