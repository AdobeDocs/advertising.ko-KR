...
AMO ID 매개 변수를 추적 URL에 추가하는 방법과 DSP 및 Search, Social, And Commerce에 대한 AMO ID 형식에 대한 자세한 내용은 &quot;[Adobe Advertising IDs used by [!DNL Analytics]](/help/integrations/analytics/ids.md#amo-id)&quot;을(를) 참조하십시오.

>[!MORELIKETHIS]
>
>* [개요 [!DNL Analytics for Advertising]](/help/integrations/analytics/overview.md){target="_blank"}
>* [에서 사용하는  [!DNL Analytics]](/help/integrations/analytics/ids.md#amo-id){target="_blank"}Adobe Advertising ID
