...
* 광고주가 Adobe Analytics 통합을 사용하는 경우 접미사에 다음 중 하나가 포함되어야 합니다.
   ...
   * 성과 최대 캠페인, 초안 및 실험 캠페인에 대한 캠페인 및 광고 그룹 수준 보고를 지원하는 최신 [!DNL Google Ads]AMO ID 형식[(](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/amo-id#dimension-items)부터 시작)을 사용하는 `s_kwcid` 계정:

     `ef_id={gclid}:G:s&s_kwcid=AL!{userid}!3!{creative}!{matchtype}!{placement}!{network}!{product_partition_id}!{keyword}!{campaignid}!{adgroupid}`

     계정에 서버측 AMO ID 구현이 있고 계정 또는 캠페인 설정 &quot;[!UICONTROL Auto Upload]&quot;이(가) 활성화되어 있으면 매개 변수가 자동으로 추가됩니다. 그렇지 않으면 수동으로 추가해야 합니다. &quot;[&#x200B; [!DNL Analytics]에서 사용하는 &#x200B;](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/amo-id-implement)Adobe Advertising ID를 참조하십시오.&quot;
