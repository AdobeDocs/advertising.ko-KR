...
description: '[!UICONTROL MSA Network Performance Report]에 대해 알아봅니다.'
...
이 보고서는 지정된 [!DNL Microsoft Advertising] 계정에 대한 광고 배포(검색 또는 대상)별로 캠페인 수준 성과(비용, 클릭 수, 노출 횟수 및 [!DNL Microsoft Advertising] 추적 매출)를 표시합니다.
