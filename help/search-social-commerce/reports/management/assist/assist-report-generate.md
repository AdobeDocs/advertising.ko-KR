...
1. 데이터 테이블 위의 도구 모음에서 **[!UICONTROL Create Report]**, 커서를 위로 가져갑니다. **[!UICONTROL Assist Reports]**&#x200B;을 클릭하고 보고서 유형을 클릭합니다.

1. (선택 사항) [!UICONTROL Report Settings] 창, 기본값 변경 [보고서 설정](assist-report-settings.md):
   ...
   1. (선택 사항) **[!UICONTROL Columns]** 을 클릭하고, 보고서의 기본 열을 변경합니다.
