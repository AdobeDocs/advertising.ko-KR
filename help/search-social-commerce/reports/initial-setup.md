...
* Adobe Advertising이 광고주에 대해 추적하는 전환 지표를 [보고서 및 다른 보기에 사용 가능하게 만들고](/help/search-social-commerce/admin/conversion-metrics/conversion-metric-edit-available.md), 선택적으로 [가독성을 위해 열 제목에 표시되는 전환 지표의 이름을 변경]&#x200B;(/help/search-social-commerce/admin/conversion-metrics/conversion-metric-edit-display-name.md)합니다.
