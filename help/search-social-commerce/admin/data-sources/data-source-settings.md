...
| | [!UICONTROL Google Analytics Dimension] | 다음 [!DNL Google Analytics] Adobe Advertising &quot;ef_id&quot; 쿼리 문자열 매개 변수의 값으로 채워진 사용자 지정 차원입니다. 올바른 차원이 목록에 없으면 다음 주소로 문의하십시오. [!DNL Google Analytics] 구현 팀.<br><br>ef_id는 데이터를 전달할 기본 키로 사용됩니다. [!DNL Google Analytics] Adobe Advertising. |
