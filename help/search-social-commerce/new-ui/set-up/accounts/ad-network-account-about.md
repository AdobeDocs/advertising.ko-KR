...
*[!DNL Google Ads], [!DNL Microsoft Advertising], [!DNL LY Ads], [!DNL Yahoo DSP], [!DNL Yandex] 및 기존 [!DNL Baidu] 계정*

Search, Social 및 Commerce은 지원되는 광고 네트워크 계정과 동기화(*동기화*)하므로 광고의 성능을 추적, 보고 및 시각화할 수 있습니다. [!DNL Yahoo DSP]을(를) 제외한 모든 광고 네트워크의 경우 선택적으로 검색, 소셜 및 Commerce에서 계정에 대한 캠페인을 관리할 수 있습니다. [!DNL Yahoo DSP]개의 캠페인이 읽기 전용입니다. 모든 광고 네트워크에 대해 포트폴리오에 캠페인을 추가하여 관리 계정의 캠페인에 대한 입찰, 캠페인 예산 및 캠페인 입찰 전략 타겟을 최적화하는 최적화 기능을 허용할 수 있습니다.
...
동기화된 캠페인을 만들고 편집하는 방법에 대한 자세한 내용은 &quot;캠페인 관리&quot; 장을 참조하십시오.

## 수동으로 데이터를 업로드하는 계정

검색, 소셜 및 Commerce에서 API 지원을 제공하지 않는 온라인 광고 네트워크의 경우 캠페인 콘텐츠와 오프라인 비용을 업로드하고, 보고 및 성능 시뮬레이션을 위해 계정에 대한 클릭 및 전환 데이터를 사용할 수 있습니다. Search, Social 및 Commerce은 데이터를 광고 네트워크와 동기화하지 않으며, 자동화된 입찰을 제공하지 않으며, 최적화의 유형을 제공하지도 않지만, 크로스 채널 인사이트를 간소화하고 수동 최적화의 기회를 식별할 수 있도록 해줍니다.

## 템플릿 기반 추적 전용 계정

*기존 [!DNL Naver] 계정에서만 사용 가능*

추적 캠페인을 사용하면 광고 네트워크에서 직접 구매하는 광고의 성과를 추적, 보고 및 시각화할 수 있습니다. Search, Social 및 Commerce은 데이터를 광고 네트워크와 동기화하지 않으며, 자동화된 입찰을 제공하지 않으며, 최적화 또는 시뮬레이션의 유형을 제공하지 않습니다.
...
검색, 소셜 및 Commerce에서 새 [!DNL Naver] 계정을 설정할 수 없습니다. [!DNL Naver] 추적 전용 캠페인에 대한 자세한 내용은 &quot;[구현 [!DNL Naver] 추적 전용 계정](/help/search-social-commerce/campaign-management/naver-tracking-only-account-implement.md)&quot;을 참조하세요.
