...
**[!UICONTROL Adobe Analytics Conversion Reporting]: [!UICONTROL Enable conversion reporting in Adobe Analytics]:**([!DNL Meta Ads] 계정; 선택 사항) [AMO ID(s_kwcid) 추적 매개 변수](/help/search-social-commerce/tracking/amo-id-tracking-parameter.md)을(를) 캠페인의 모든 광고에 추가합니다. 매개 변수를 사용하면 Adobe Analytics에서 전환을 엔티티 분류 및 클릭 데이터와 함께 지정된 보고서 세트의 Meta 광고 캠페인과 연결할 수 있습니다.
