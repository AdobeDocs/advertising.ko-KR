...
* 기본 설정 액세스 권한을 가진 표준 포트폴리오 관리 및 계획 기능이 필요한 사용자용 **[!UICONTROL Basic Optimization]:**.

* **[!UICONTROL Expert Optimization]:** 고급 전문가 수준 컨트롤을 포함하여 전체 포트폴리오 설정 액세스가 필요한 고급 사용자의 경우 모든 성과 계획, 목표, 캠페인, 설정 및 보고서 관리 권한을 포함합니다.

* **[!UICONTROL Read-Only Optimization]:** 편집하거나 만드는 기능 없이 포트폴리오, 시뮬레이션 및 캠페인에 대한 가시성이 필요한 사용자를 위한 것입니다.

* **[!UICONTROL \[Optimization\] Admin]:** 사용 가능한 모든 기능에 대한 전체 액세스 권한을 부여하고 사용자가 새 클라이언트 인스턴스(기존 광고주 계정과 동일하며 조직 ID당 하나 이상의 인스턴스가 있음)를 만들 수 있도록 합니다. 적절한 비즈니스 타당성이 없는 한 이 권한을 다른 사람에게 할당하지 마십시오.

### 제품 프로필별 기능

<!-- These don't correspond exactly to the GUI menu -->

확인 표시(✓)는 권한이 제품 프로필에 포함되어 있음을 나타냅니다.
...
| 포트폴리오 보기 | ✓ | ✓ | ✓ | ✓ |
| Portfolio 설정 보기 | ✓ | ✓ | ✓ | ✓ |
| Portfolio 성능 세부 정보 보기 | ✓ | ✓ | ✓ | ✓ |
| Portfolio 그룹 보기 | ✓ | ✓ | ✓ | ✓ |
| Portfolio 그룹 편집 | ✓ | ✓ | | ✓ |
| 기본 Portfolio 설정 편집 | ✓ | | | |
| Expert Portfolio 설정 편집 | | ✓ | | ✓ |
