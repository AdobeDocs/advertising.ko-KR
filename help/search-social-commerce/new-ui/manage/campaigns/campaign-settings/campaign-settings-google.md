...
**[!UICONTROL Campaign Type]:** 광고를 배치할 위치와 캠페인에 포함될 수 있는 광고 유형:
...
**[!UICONTROL Contains EU Political Ads]:**(유럽 연합(EU)에서 대상을 타겟팅하는 캠페인에 적용) EU 규정 2024/90: *[!UICONTROL No]* 또는 *[!UICONTROL Yes]*&#x200B;에 따라 유럽 연합에서 제공되는 광고에 대한 요구 사항에 따라 캠페인에 정치적 광고가 포함되어 있는지 여부.
...
검색 캠페인의 경우 권장 사항에도 다음 추가 설정이 필요합니다.
...
* *[!UICONTROL Enhanced CPC]:*&#x200B;은(는) 사용되지 않습니다. [!DNL Google Ads]이(가) 2025년에 기존 [향상된 CPC 입찰 전략](https://support.google.com/google-ads/answer/2464964)을 수동 CPC로 자동으로 변경하기 시작했습니다.

* *[!UICONTROL Manual CPC]*(기본값): (성과 최대 캠페인에는 사용할 수 없음) 클릭당 비용(CPC) 모델을 사용합니다. 광고 네트워크에서 캠페인에 대한 입찰을 변경하도록 허용할 수 있습니다(선택적).

  * **[!UICONTROL Enable Enhanced CPC]**(기본적으로 비활성화됨): 사용되지 않는 &quot;[!UICONTROL Enhanced CPC]&quot; 옵션을 사용하는 것과 같습니다. [!DNL Google Ads]이(가) 2025년에 기존 [향상된 CPC 입찰 전략](https://support.google.com/google-ads/answer/2464964)을 수동 CPC로 자동으로 변경하기 시작했습니다.
...
* *[!UICONTROL Maximize Conversion Value]:*(검색, 성과 최대 및 스마트 쇼핑 캠페인) 검색, 소셜 및 Commerce이 아닌 광고 네트워크는 전환 값을 최대화하기 위해 입찰을 최적화합니다. 필요한 경우 **[!UICONTROL Target Return on Ad Spend]**(ROAS)을(를) 백분율로 입력하십시오. **참고:** 캠페인 또는 광고 그룹 수준 최적화가 있는 포트폴리오의 캠페인에는 이 옵션을 사용하고 키워드 수준 최적화가 있는 포트폴리오에는 이 옵션을 사용하지 마십시오. 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오에서 검색, 소셜 및 Commerce은 캠페인 수준 또는 (사용 가능한 경우) 광고 그룹 수준의 Target ROAS를 최적화합니다.

* *[!UICONTROL Maximize Conversions]:*(검색, 표시 및 성과 최대 캠페인) 검색, 소셜 및 Commerce이 아닌 광고 네트워크는 전환을 최대화하기 위해 입찰을 최적화합니다. 필요한 경우 **[!UICONTROL Target CPA]**(획득당 비용) 및 적용 가능한 **[!UICONTROL Portfolio]** 입찰 전략을 입력합니다. **참고:** 캠페인 또는 광고 그룹 수준 최적화가 있는 포트폴리오의 캠페인에는 이 옵션을 사용하고 키워드 수준 최적화가 있는 포트폴리오에는 이 옵션을 사용하지 마십시오. 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오에서 검색, 소셜 및 Commerce은 캠페인 수준 또는 (사용 가능한 경우) 광고 그룹 수준의 Target CPA를 최적화합니다.

* *[!UICONTROL Target CPA]:*(디스플레이 전용 캠페인) 검색, 소셜 및 Commerce이 아닌 광고 네트워크는 선택적 **[!UICONTROL Target CPA]**(획득당 비용)을 기준으로 입찰을 최적화합니다. 이 값은 획득(전환)에 대해 지불할 30일 평균 금액입니다. **참고:** 캠페인은 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오에서 [!UICONTROL Weekly] 또는 [!UICONTROL Google Target CPA]을(를) 제외한 지출 전략이 포함된 포트폴리오(키워드 수준 최적화가 포함된 포트폴리오는 아님)입니다. 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오에서 검색, 소셜 및 Commerce은 캠페인 수준 또는 (사용 가능한 경우) 광고 그룹 수준의 Target CPA를 최적화합니다.
...
* *[!UICONTROL Target Return on Ad Spend]:*(쇼핑 캠페인) 검색, 소셜 및 Commerce이 아닌 광고 네트워크는 백분율로 지정된 **[!UICONTROL Target ROAS]**(광고 투자 수익률)을 기반으로 입찰을 최적화합니다. **참고:** [!UICONTROL Weekly] 또는 [!UICONTROL Google Target ROAS]을(를) 제외한 모든 지출 전략에서 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오(키워드 수준 최적화가 포함된 포트폴리오는 제외)의 캠페인에 이 옵션을 사용하십시오. 캠페인 또는 광고 그룹 수준 최적화가 포함된 포트폴리오에서 검색, 소셜 및 Commerce은 캠페인 수준 또는 (사용 가능한 경우) 광고 그룹 수준의 Target ROAS를 최적화합니다.
...
## [!UICONTROL Advanced Device Options] 탭
...
**[!UICONTROL AI Max]:** 캠페인에 대해 [[!UICONTROL AI Max]](https://support.google.com/google-ads/answer/15910366)&#x200B;(AI 기반 검색어 일치, 텍스트 사용자 지정 및 최종 URL 확장)을 사용할지 여부를 지정합니다. **[!UICONTROL AI Max]**&#x200B;을(를) 사용하면 두 가지 추가 설정을 사용할 수 있습니다.

* **[!UICONTROL Text customization]:** [!DNL Google Ads]이(가) 기존 광고 및 랜딩 페이지 복사본을 기반으로 광고 복사본, 헤드라인 및 설명을 사용자 지정하는 데 생성 AI를 사용할 수 있도록 할지 여부입니다.

* **[!UICONTROL Final URL expansion]:** [!DNL Google Ads]이(가) 검색 의도에 따라 웹 사이트에서 가장 관련성이 높은 랜딩 페이지로 트래픽을 라우팅할지 여부를 지정합니다. 이 설정은 **[!UICONTROL Text customization]**&#x200B;을(를) 사용하도록 설정한 경우에만 사용할 수 있습니다.

<!-- Clarify why this is "Unspecified" and read-only for me as of 7/23. Also, shouldn't we reword this? -->

**[!UICONTROL Bundling required]:**([!UICONTROL AI Max] 기능을 사용하는 기존 캠페인은 읽기 전용입니다.) *[!UICONTROL Required]*, *[!UICONTROL Not required]* 또는 *[!UICONTROL Unspecified]* 캠페인에 대한 텍스트 사용자 지정 및 브랜드 목록 컨트롤을 준수하거나 수정하려면 [!UICONTROL AI Max]을(를) 사용해야 하는지 여부를 지정합니다.

<!-- Is this based on the advanced location options set elsewhere in Google Ads editor? -->

**[!UICONTROL Geo Targeting Type]:**([!UICONTROL AI Max] 기능이 활성화된 기존 캠페인; 읽기 전용) 캠페인의 광고 그룹에 [!UICONTROL Locations of Interest] 대상이 포함된 경우 타겟팅되는 사용자 관심 유형: *[!UICONTROL Search Interest]*(지정된 위치에 관심 있는 사용자), *[!UICONTROL Presence]*(지정된 위치에 있거나 정기적으로 관심 있는 사용자) 또는 *[!UICONTROL Presence or Interest]*(지정된 위치에 있거나 정기적으로 관심 있는 사용자).
...
**[!UICONTROL Final URL]:** 자산 그룹에서 만든 모든 광고의 최종 URL입니다. <!-- For campaigns created within Search, Social, & Commerce, final URL expansion is automatically enabled for the campaign, and [!DNL Google Ads] replaces this value with a more relevant landing page based on the user's search query and intent, and also customizes the headline based on the landing page content. You can disable final URL expansion, or exclude specific URLs from expansion, from within the [!DNL Google Ads] editor. -->

**[!UICONTROL Images]:** 하나 이상의 가로 이미지(1.91:1, 최소 600 x 314픽셀)와 하나 이상의 사각형 이미지(1:1, 최소 300 x 300픽셀)를 포함하여 최대 15개의 광고 이미지입니다. 원할 경우 세로 이미지(4:5, 최소 480 x 600픽셀)를 포함할 수 있습니다. [[!DNL Google Ads] 이미지 사양](https://support.google.com/google-ads/answer/10724492?hl=en&ref_topic=10631992#zippy=,audience-signal-inputs,video-specifications,image-specifications)을 참조하세요. 이미지를 업로드하거나 [!UICONTROL Asset Library]에서 선택할 수 있지만 둘 다 동일한 작업에서 선택할 수는 없습니다.
...
**[!UICONTROL Logos]:** 하나 이상의 정사각형(1:1, 128x128픽셀) 로고. 가로(4:1, 최소 512 x 218픽셀) 로고를 선택적으로 포함할 수 있습니다. 총 5개의 로고를 포함할 수 있습니다. [[!DNL Google Ads] 로고 사양](https://support.google.com/google-ads/answer/10724492?hl=en&ref_topic=10631992#zippy=,audience-signal-inputs,video-specifications,image-specifications)을 참조하세요. 이미지를 업로드하거나 [!UICONTROL Asset Library]에서 선택할 수 있지만 둘 다 동일한 작업에서 선택할 수는 없습니다.
...
신규 고객, 기존 고객 또는 두 고객 모두를 위해 캠페인을 최적화합니다. 이 설정을 사용하려면 먼저 [!DNL Google Ads] 계정에 대해 새 고객 확보 목표를 활성화하거나 해당하는 경우 관리자 계정에 대해 새 고객 확보 목표를 활성화해야 합니다. 목표는 적격한 기존 고객 목록과 전환 설정에서 새 고객에 대한 추가 전환 값을 정의합니다. [!DNL Google Ads] 도움말의 1-2단계 &quot;[새 고객 확보 목표 활성화](https://support.google.com/google-ads/answer/14007601)&quot;를 참조하십시오.

**[!UICONTROL Customer Goal]:** 고객 확보 목표 유형:

* *[!UICONTROL All Customers]*(기본값): 신규 고객과 기존 고객 모두에 대해 동일하게 최적화합니다.

* *[!UICONTROL New Customers]:* 새 고객 확보의 우선 순위를 지정합니다. 이 옵션을 선택하면 **[!UICONTROL New Customer Bid Adjustment]** 설정이 표시됩니다.

* *[!UICONTROL Existing Customers]:* 기존 고객을 유지하는 우선 순위를 지정합니다.

**[!UICONTROL New Customer Bid Adjustment]:**(**[!UICONTROL Customer Goal]**&#x200B;이(가) **[!UICONTROL New Customers]**(으)로 설정됨) 새 고객을 타깃팅할 때 입찰에 적용되는 승수(0.1 ~ 10.0)입니다. 기본값은 1.0(조정 없음)입니다. 예를 들어 1.5배로 새 고객의 입찰가를 50% 증가시키고, 2.0배로 새 고객의 입찰가를 두 배 증가시키며, 0.5배로 새 고객의 입찰가를 50% 감소시킵니다.
