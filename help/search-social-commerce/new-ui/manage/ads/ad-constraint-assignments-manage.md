---
title: 광고에 대한 제한 할당 관리
description: 광고에 제약 조건을 할당하는 방법을 알아봅니다.
...
1. 제한을 할당 해제할 각 광고 옆에 있는 확인란을 선택합니다.
