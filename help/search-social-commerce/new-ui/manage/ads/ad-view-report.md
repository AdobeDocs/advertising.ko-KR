...
# (새 UI) [!UICONTROL Ads] 보기에서 데이터 보기 보고서를 관리합니다.

*Beta 기능*

[!UICONTROL Ads] 보기에서 하나 이상의 광고에 대한 데이터 행을 포함하는 보고서를 생성한 다음 이 보고서를 Microsoft Excel 워크시트 파일(XLXS 형식)로 다운로드할 수 있습니다. 이 보고서에는 보기에 표시된 모든 열이 포함됩니다.
