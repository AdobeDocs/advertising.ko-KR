---
title: (새 UI) 목표를 위한 성능 데이터 다운로드
description: 스프레드시트 파일에서 목표를 다운로드하는 방법을 알아봅니다.
...
# (새 UI) 목표를 위한 성능 데이터 다운로드

*Beta 기능*

<!-- EDIT ALL -->

연결된 포트폴리오 수, 클릭 값, 클릭 수, 비용, 노출당 비용(CPC) 및 여러 목표에 대한 노출수를 한 번에 [!DNL Microsoft Excel] 통합 문서(XLSX 파일) 형식의 파일로 다운로드할 수 있습니다.

## 필터링된 데이터 행으로 보고서 생성

1. 메인 메뉴에서 **[!UICONTROL Goals]>[!UICONTROL Objectives]**&#x200B;을(를) 클릭합니다.

1. 다운로드할 데이터의 목표를 지정합니다.

   * 특정 목표에 대한 데이터를 다운로드하려면 목표 옆에 있는 확인란을 선택합니다.
...
1. [!UICONTROL Grid Reports] 설정에서 고유한 보고서 이름을 입력한 다음 **[!UICONTROL Generate]**&#x200B;을(를) 클릭합니다.
   ...
   기본적으로 파일 이름은 &quot;objective_YYYYMMDD_NNNN&quot;으로 지정됩니다. 여기서 &quot;NNNN&quot;은 순차적 작업 번호입니다(예: &quot;objective_20250402_1326).
