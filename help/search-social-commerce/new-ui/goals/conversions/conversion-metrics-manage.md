...
광고주의 [전환](/help/search-social-commerce/glossary.md#c-d) 지표는 Search, Social, &amp; Commerce 및 Advertising DSP 전체에서 사용됩니다.
...
사용 가능한 전환 지표 목록에서 광고주의 데이터에 대한 액세스 권한이 있는 각 사용자는 특정 지표를 선택하거나 생략하는 등 관리 보기 및 보고서에 사용할 수 있는 지표를 사용자 지정할 수 있습니다.
...
검색된 데이터의 맞춤법과 정확히 동일한 지표 이름을 사용하거나 가독성을 위해 열 제목에 표시되는 이름을 변경할 수 있습니다.
...
## 관리 보기 및 보고서에서 사용할 수 있는 전환 지표 변경 {#conversion-metrics-change-available}
