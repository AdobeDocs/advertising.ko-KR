...
+ 소개 {#intro}
  ...
  + [정책 및 지침(링크)](https://experienceleague.adobe.com/en/docs/advertising/policies/ad-requirements-policy){target="_blank"}
+ 시작 {#getting-started}
  ...
  + 관리 {#manage}
    ...
    + 광고 {#ads}
      ...
      + 광고 네트워크별 광고 설정 {#ad-settings-by-network}
        ...
        + [[!DNL ChatGPT Ads] 광고 설정](/help/search-social-commerce/new-ui/manage/ads/ad-settings-chatgpt.md)
  ...
  + 캠페인 관리 {#management}
    ...
    + [!UICONTROL Campaigns] > [!UICONTROL Campaigns] 보기 내에서 데이터 관리 {#campaigns}
      ...
      + 캠페인 {#campaigns}
        ...
        + 광고 네트워크별 캠페인 설정 {#campaign-settings-by-network}
          ...
          + [[!DNL LY Ads] 캠페인 설정](/help/search-social-commerce/campaign-management/campaigns/campaign-settings-yahoo-japan.md)
          + [[Meta Ads] 캠페인 설정](/help/search-social-commerce/campaign-management/campaigns/campaign-settings-meta.md)
    ...
    + 일괄 시트를 통해 대량 데이터 관리 {#bulksheets}
      ...
      + Bulksheets에 필수/포함된 데이터{#bulksheet-data-formats}
        ...
        + [ [!DNL Yahoo DSP] 계정의 일괄 시트 데이터](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
