...
+ (Beta) 새 사용자 인터페이스 {#new-ui}
   ...
   + 관리 {#manage}
      + 포트폴리오 {#portfolios}
         ...
         + [포트폴리오 그룹 관리](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-group-manage.md)
         + [포트폴리오 만들기](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create.md)
         + [포트폴리오 복제](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-duplicate.md)
         + [포트폴리오 세부 정보 편집](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-edit.md)
         + [일괄 시트 파일을 사용하여 포트폴리오 설정 일괄 편집](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-bulksheets.md)
         + [포트폴리오 이름 바꾸기](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)
         + [포트폴리오 상태 변경](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-change-status.md)
         + [Portfolio 설정](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-settings.md)
         + [[!UICONTROL Portfolios] 보기에서 사용자 지정 시뮬레이션 실행](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create-simulation.md)
         + [[!UICONTROL Portfolios] 보기에서 성능 그래프 보기](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
   ...
   + 보고서 {#reports}
      + 레이블 분류 {#label-classifications}
         + [레이블 분류 정보](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about)
         + [레이블 분류 만들기](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-create)
         + [캠페인 관리 보기에서 계정 구성 요소에 분류 값 할당](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management)
         + [일괄 시트를 사용하여 계정 구성 요소에 분류 값 할당](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets)
         + [계정 구성 요소에서 레이블 분류 값 제거](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
         + [레이블 분류 값 삭제](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-delete)
         + [레이블 분류 삭제](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-delete)
   + Target {#target}
      + 키워드 {#keywords}
...
+ 캠페인 관리 {#campaign-management}
   ...
   + [ [!DNL Naver] 추적 전용 계정 구현](/help/search-social-commerce/campaign-management/naver-tracking-only-account-implement.md)
   + 캠페인 관리 {#management}
      + [광고 네트워크 캠페인 관리 옵션](/help/search-social-commerce/campaign-management/campaigns/campaign-management-options.md)
      + [!UICONTROL Campaigns] > [!UICONTROL Campaigns] 보기 내에서 데이터 관리 {#campaigns}
         ...
         + 광고 {#ads}
            ...
            + 광고 네트워크별 광고 설정 {#ad-settings-by-network}
               ...
               + [[!DNL Google Ads] 통화 전용 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
      ...
      + 고유한 워크플로우를 통해 캠페인, 광고 및 전환 구현{#special-workflows}
         ...
         + [오프라인 전환을 위해  [!DNL Microsoft Advertising] 향상된 전환 구현](/help/search-social-commerce/campaign-management/special-workflows/microsoft-enhanced-conversions.md)
...
+ 인사이트 및 보고서 {#insights-reports}
   + Advertising Insights {#insights}
      + [[!UICONTROL Advertising Insights] 정보](/help/search-social-commerce/advertising-insights/insight-about.md)
      + [ [!DNL Advertising Insight] 생성](/help/search-social-commerce/advertising-insights/insight-generate.md)
      + [ [!DNL Advertising Insight] 보기 또는 저장](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [ [!DNL Advertising Insight] 삭제](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + 보고서 {#reports}
      ...
      + 보고서 관리 {#report-management}
         ...
         + 전문 보고서 {#specialty-reports}
            ...
            + 전문 보고서 형식 {#specialty-report-formats}
               ...
               + [[!UICONTROL Google Performance Max Placement Report]](/help/search-social-commerce/reports/management/specialty/google-performance-max-placement-report.md)
...
+ 도구 {#tools}
   ...
   + 추적 태그를 만들고 디코딩하는 도구{#tracking}
      ...
      + [Adobe Advertising 전환 태그 생성 및 구현](/help/search-social-commerce/tools/conversion-tag-generate.md)
