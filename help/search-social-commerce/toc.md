...
+ 소개 {#intro}
   ...
   + Adobe Experience Cloud과 통합 {#integrations}
      ...
      + [Adobe [!DNL Analytics for Advertising] (링크)](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html)
      + [Adobe Audience Manager과 통합(링크)](https://experienceleague.adobe.com/docs/advertising/integrations/audience-manager/overview.html)
   + [고객 개인정보 보호 지원(링크)](https://experienceleague.adobe.com/docs/advertising/privacy/home.html)
   + [정책 및 지침(링크)](https://experienceleague.adobe.com/docs/advertising/policies/ad-requirements-policy.html)
+ 시작 {#getting-started}
...
+ 일반 작업 {#common-tasks}
   ...
   + 데이터 보기 사용자 지정 {#data-views}
      ...
      + 애드혹 보기 설정 {#ad-hoc-settings}
         ...
         + [열 집합에서 편집 및 정렬 [!UICONTROL Custom Columns] 아이콘](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
         ...
         + 열 값으로 데이터 필터링 {#filter-column-values}
            ...
            + [열 필터 제거](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-filter-remove.md)
   + 사용자 지정 지표 관리 {#custom-metrics}
      + [사용자 지정 지표 기본 정보](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-about.md)
      + [사용자 지정 지표 만들기](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-create.md)
      + [사용자 지정 지표 편집](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-edit.md)
      + [사용자 지정 지표 삭제](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-delete.md)
      + [사용자 지정 지표 설정](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-settings.md)
   + 일반적인 탐색, 편집 및 선택 작업 {#navigation-editing-selection}
      + [여러 행 선택](/help/search-social-commerce/common-tasks/navigation-editing-selection/multiple-rows-select.md)
   ...
   + 클릭 추적 {#click-tracking}
      ...
      + 클릭 추적 URL 구성 요소 {#click-tracking-components}
         + 클릭 추적 URL의 표준 형식 {#click-tracking-formats}
            ...
            + [클릭 추적 형식 [!DNL Baidu]](/help/search-social-commerce/tracking/formats-click-tracking-baidu.md)
            + [클릭 추적 형식 [!DNL Google Ads]](/help/search-social-commerce/tracking/formats-click-tracking-google.md)
            + [클릭 추적 형식 [!DNL Microsoft Advertising]](/help/search-social-commerce/tracking/formats-click-tracking-microsoft.md)
            + [클릭 추적 형식 [!DNL Naver]](/help/search-social-commerce/tracking/formats-click-tracking-naver.md)
            + [클릭 추적 형식 [!DNL Yahoo! Display Network]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-display-network.md)
            + [클릭 추적 형식 [!DNL Yahoo! Japan Ads]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-japan.md)
      ...
      + [Adobe Advertising 쿠키](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html)
...
+ 캠페인 관리 {#campaign-management}
   ...
   + 계정 설정 {#campaign-management-accounts}
      + 광고 네트워크 계정 {#ad-network-accounts}
         ...
         + [에 대한 s\_kwcid 추적 코드 업데이트 [!DNL Google Ads] account](/help/search-social-commerce/campaign-management/accounts/update-skwcid-google.md)
   ...
   + 캠페인 관리 {#management}
      + [광고 네트워크 캠페인 관리 옵션](/help/search-social-commerce/campaign-management/campaigns/campaign-management-options.md)
      + 내에서 데이터 관리 [!UICONTROL Campaigns] > [!UICONTROL Campaigns] 조회수 {#campaigns}
         ...
         + 키워드 {#keywords}
            ...
            + [키워드 및 부정적 키워드의 상태 변경](/help/search-social-commerce/campaign-management/campaigns/keyword-status-edit.md)
         ...
         + 광고 {#ads}
            ...
            + 광고 네트워크별 광고 설정 {#ad-settings-by-network}
               + [[!DNL Baidu] 텍스트 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-baidu-text.md)
               + [[!DNL Google Ads] 호출 전용 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               + [[!DNL Google Ads] 확장된 동적 검색 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
               + [[!DNL Google Ads] 반응형 검색 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-rsa.md)
               + [[!DNL Microsoft Advertising] 확장된 동적 검색 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
               + [[!DNL Microsoft Advertising] 멀티미디어 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
               + [[!DNL Microsoft Advertising] 제품 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-product.md)
               + [[!DNL Microsoft Advertising] 반응형(대상) 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
               + [[!DNL Microsoft Advertising] 반응형 검색 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
               + [[!DNL Yandex] 텍스트 광고 설정](/help/search-social-commerce/campaign-management/campaigns/ad-settings-yandex-text.md)
         ...
         + 광고 확장 {#ad-extensions}
            + [!DNL Google Ads] 설명선 확장 {#callouts}
      ...
      + 일괄 시트를 통해 대량 데이터 관리 {#bulksheets}
         ...
         + [일괄 시트 파일의 랜딩 페이지 유효성 검사](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-validate-landing-pages.md)
         + [생성 또는 업로드한 일괄 시트 파일 내보내기](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-export.md)
         + [일괄 시트 파일 또는 수정된 오류 파일 업로드](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-upload.md)
         + [게시물 일괄 시트 또는 수정된 오류 파일](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-post.md)
         ...
         + Bulksheets에 필수/포함된 데이터{#bulksheet-data-formats}
            ...
            + [다음에 대한 필수 일괄 시트 데이터 [!DNL Baidu] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-baidu.md)
            + [다음에 대한 필수 일괄 시트 데이터 [!DNL Google Ads] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-google.md)
            + [다음에 대한 필수 일괄 시트 데이터 [!DNL Microsoft Advertising] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-microsoft.md)
            + [다음에 대한 필수 일괄 시트 데이터 [!DNL Naver] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-naver.md)
            + [다음에 대한 일괄 시트 데이터 [!DNL Yahoo! Display Network] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
            + [다음에 대한 일괄 시트 데이터 [!DNL Yahoo! Japan] 계정](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
      ...
      + 인벤토리 피드를 사용하여 캠페인 데이터 자동화 {#inventory-feeds}
         ...
         + [수정자 관리](/help/search-social-commerce/campaign-management/inventory-feeds/modifiers-manage.md)
         + 템플릿 {#feed-templates}
            + [광고 템플릿 관리](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/ad-template-manage.md)
            + [텍스트 광고 및 반응형 검색 광고 템플릿 설정](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-text-rsa.md)
      ...
      + 고유한 워크플로우로 캠페인 및 광고 구현{#special-campaign-types}
         + [구현 [!DNL Google Ads] 동적 검색 광고](/help/search-social-commerce/campaign-management/special-campaign-types/google-dynamic-search-ads.md)
         + [구현 [!DNL Google Ads] 성과 최대 캠페인](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
   ...
   + 레이블 분류 관리 {#label-classifications}
      + [레이블 분류 정보](/help/search-social-commerce/campaign-management/label-classifications/classification-about.md)
      + [레이블 분류 만들기](/help/search-social-commerce/campaign-management/label-classifications/classification-create.md)
      + [캠페인 관리 보기에서 계정 구성 요소에 분류 값 할당](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
      + [일괄 시트를 사용하여 계정 구성 요소에 분류 값 할당](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
...
+ 인사이트 및 보고서 {#insights-reports}
   + 광고 인사이트 {#insights}
      + [정보 [!UICONTROL Advertising Insights]](/help/search-social-commerce/advertising-insights/insight-about.md)
      + [생성 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-generate.md)
      + [보기 또는 저장 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [삭제 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + 보고서 {#reports}
      ...
      + 보고서 관리 {#report-management}
         ...
         + 지원 보고서 {#assist-reports}
            + [지원 보고서 정보](/help/search-social-commerce/reports/management/assist/assist-report-about.md)
         ...
         + 모델 정확도 보고서 {#model-accuracy-reports}
            ...
            + 모델 정확도 보고서 형식 {#assist-report-formats}
               + [다음 [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-report.md)
               + [다음 [!UICONTROL Forecast Accuracy (Actuals) Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-actuals-report.md)
      ...
      + 보고서 자동화 {#report-automation}
         + 보고서 템플릿 {#report-templates}
            + [보고서 템플릿 기본 정보](/help/search-social-commerce/reports/automation/templates/template-about.md)
            + [보고서 템플릿 보기](/help/search-social-commerce/reports/automation/templates/template-view.md)
            + [보고서 템플릿 만들기](/help/search-social-commerce/reports/automation/templates/template-create.md)
            + [보고서 템플릿 편집](/help/search-social-commerce/reports/automation/templates/template-edit.md)
         ...
         + 스프레드시트 피드 {#spreadsheet-feeds}
            ...
            + [만들기 [!DNL Excel] 스프레드시트 보고서 피드용 템플릿](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
            ...
            + [스프레드시트 보고서 피드 파일 보기 또는 저장](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-view-or-save.md)
            + [스프레드시트 보고서 피드 삭제](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-delete.md)
   ...
   + 알림 {#notifications}
      ...
      + [푸시 알림 활성화 및 비활성화 위치 [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
      + [설치 및 제거 [!UICONTROL Notification Center] 웹 애플리케이션](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
   + 사용자 지정 경고 {#alerts}
      + [사용자 지정 경고 정보](/help/search-social-commerce/alerts/alert-about.md)
      + 경고 템플릿 {#alert-templates}
         + [사용자 지정 경고 템플릿 만들기](/help/search-social-commerce/alerts/alert-template-create.md)
         + [사용자 지정 경고 템플릿 편집](/help/search-social-commerce/alerts/alert-template-edit.md)
         + [사용자 지정 경고 템플릿 일시 중지](/help/search-social-commerce/alerts/alert-template-pause.md)
         + [사용자 지정 경고 템플릿 활성화](/help/search-social-commerce/alerts/alert-template-activate.md)
         + [사용자 지정 경고 템플릿 삭제](/help/search-social-commerce/alerts/alert-template-delete.md)
         + [사용자 지정 경고 템플릿 설정](/help/search-social-commerce/alerts/alert-template-settings.md)
...
+ 도구 {#tools}
   ...
   + 다음에 대한 지표 업로드 [!DNL Naver] 추적 전용 계정 {#generic-tracking}
   ...
   + [복제 [!DNL Google Ads] 의 캠페인 [!DNL Microsoft Advertising]](/help/search-social-commerce/tools/google-campaign-replication-in-microsoft.md)
+ 관리 {#admin}
   ...
   + 데이터 소스 구성 {#data-sources}
      + [동기화 기본 정보 [!DNL Google Analytics] 전환 지표](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      + [구성 사전 요구 사항 [!DNL Google Analytics] 데이터 소스](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [구성 [!DNL Google Analytics] 데이터 소스로 보기](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [편집 [!DNL Google Analytics] 데이터 소스](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
